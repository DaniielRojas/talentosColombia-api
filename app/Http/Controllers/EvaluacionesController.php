...
use App\Http\Requests\ActualizarEvaluacion;
use App\Http\Requests\CrearEvaluacion;
...
class EvaluacionesController extends Controller
{
    ...
    public function store(CrearEvaluacion $request): JsonResponse
    {
        try {
     ...
     */
    public function update(ActualizarEvaluacion $request, $id): JsonResponse
    {
        try {
