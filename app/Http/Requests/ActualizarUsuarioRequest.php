...
class ActualizarUsuarioRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'correo' => ["required", "email", Rule::unique('usuarios')->ignore($usuario_id)] ,// Asegura que el correo sea único en la tabla 'usuarios' y tenga formato de correo electrónico
